...
package games.absolutephoenix.omnicoingenerator.gui;
...
public class GuiOmnicoinGeneratorInventory extends ElementsOmnicoinGenerator.ModElement {
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(World world, int x, int y, int z, EntityPlayer player) {
			...
			this.customSlots.put(0, this.addSlotToContainer(new Slot(internal, 0, 81, 33) {
				@Override
		...
		private void slotChanged(int slotid, int ctype, int meta) {
			if (this.world != null && this.world.isRemote) {
				OmnicoinGenerator.PACKET_HANDLER.sendToServer(new GUISlotChangedMessage(slotid, x, y, z, ctype, meta));
	...
	public static class GuiWindow extends GuiContainer {
		...
		private static final ResourceLocation texture = new ResourceLocation("omnicoingenerator:textures/omnicoingeneratorinventory.png");
		@Override
		...
		protected void drawGuiContainerForegroundLayer(int par1, int par2) {
			this.fontRenderer.drawString("Omnicoin Generator", 3, 3, -16777216);
		}
		...
		protected void actionPerformed(GuiButton button) {
			OmnicoinGenerator.PACKET_HANDLER.sendToServer(new GUIButtonPressedMessage(button.id, x, y, z));
